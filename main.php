	...
	<div id="slides">
      	...
      	<?php 
      		...
      		while ($rowBanner=mysqli_fetch_assoc($queryBanner)) {
      			echo "<a href='".BASE_URL."$rowBanner[link]'/><img src='".BASE_URL."assets/images/slide/$rowBanner[gambar]' /></a>";	
      		}
      	 ?>
    </div>
	<div id="frame-barang">
		<ul>
			...
			if ($kategori_id) {
				...
				while ($row=mysqli_fetch_assoc($query)) {
					...
					#memperbaiki link url detail barang dan kategori
					...
					echo "<li $style>
								<p class='price'>".rupiah($row['harga'])."</p>
									<a href='".BASE_URL."$row[barang_id]/$kategori/$barang.html'>
										<img src='".BASE_URL."assets/images/barang/$row[gambar]' />
									</a>
								<div class='keterangan-gambar'>	
									<p>
										<a href='".BASE_URL."$row[barang_id]/$kategori/$barang.html'>$row[nama_barang]
										</a>
									</p>
